...
const SingleLevelMenu: FC<SingleLevelMenuProps> = React.memo(
  function SingleLevelMenu({
    ...
    const isOpen = useMemo(() => {
      return openCategories.includes(category.Id);
    }, [openCategories, category.Id]);
    const handleClick = () => {
      onClickCategory([...parentCategories, category]);
    };
    const childrenParentList = useMemo(
            ...
            <List component="div" disablePadding>
              {category.ChildList.map((child) => (
                <SingleLevelMenu
                  key={child.Id}
                  category={child}
                  parentCategories={childrenParentList}
...
/*
將註解掉版本的改成parentCategories={initialParents}
const initialParents = useMemo(() => [], []);
const childrenParentList = useMemo(() => 
    [...parentCategories, category],
    [category.Id, parentCategories]
  );
parentCategories={childrenParentList}
*/
